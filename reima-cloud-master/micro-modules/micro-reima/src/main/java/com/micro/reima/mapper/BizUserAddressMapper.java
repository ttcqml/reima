 ...
 * @date 2021-12-25
 */
public interface BizUserAddressMapper 
{

    public SimpleUserAddressVo selectSimpleUserAddressVoByUserId(Long userId);

    public BizUserAddress selectBizUserAddressByUserId(Long userId);
    /**
     * 查询用户地址
     * 
     * @param id 用户地址主键
